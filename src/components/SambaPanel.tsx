          ...
          <div className="space-y-4 max-w-5xl mx-auto">
              ...
              <div className="bg-white dark:bg-[#1f1f22] p-5 rounded-2xl border border-blue-100 dark:border-blue-500/20 shadow-sm space-y-4 animate-in slide-in-from-top-4">
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1.5 text-[10px] text-slate-400 dark:text-slate-500">Choose a folder inside the managed-disk directory or another Samba root allowed by the server administrator.</p>
                  </div>
                </div>
            ...
            {shares.map(share => (
              <div key={share.id} className="bg-white dark:bg-[#1f1f22] p-5 rounded-2xl border border-slate-200 dark:border-white/10 shadow-sm flex flex-col gap-4">
                ...
                {share.enabled !== 0 && share.published === false && (
                  <div className="rounded-xl border border-amber-200 bg-amber-50 px-3 py-2.5 text-xs text-amber-800 dark:border-amber-500/25 dark:bg-amber-500/10 dark:text-amber-200">
                    Windows cannot connect because this share is not in the live Samba configuration: {share.publishError}
                  </div>
                )}
