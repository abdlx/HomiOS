          ...
          <div className="absolute inset-0 z-10 flex items-center justify-center p-6">
            <div className="max-w-md text-center">
              ...
              <p className="text-sm text-white/55 mb-5">
                {status.enabled ? 'The optional Immich service is configured but has not become reachable yet.' : 'Re-run the installer with --with-immich, or run openfinder-update --with-immich.'}
              </p>
