...
export default function TransferCenter({
  ...
  return (
    <div
      ...
      style={{
        bottom: `calc(${isMobile ? '5rem' : '1.5rem'} + var(--homios-activity-panel-offset, 0px))`,
        maxHeight: `min(430px, calc(100dvh - ${isMobile ? '6rem' : '2.5rem'} - var(--homios-activity-panel-offset, 0px)))`,
      }}
    >
